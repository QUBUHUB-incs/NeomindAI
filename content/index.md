...
Notes
	...
	•	Fully self-contained: all data embedded via Base64.
...
1. Replace the placeholder Base64 (`PNG` and `PDF`) with your real files using:  

```bash
base64 neomind_board_styled.png > png_base64.txt
base64 neomind_hardware_manual.pdf > pdf_base64.txt
